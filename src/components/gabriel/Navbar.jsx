...
const Navbar = ({ className, onMenuClick }) => {
  ...
  const isDashboard =
    location.pathname.startsWith(PATH.dashboard.default) ||
    location.pathname.startsWith(PATH.doctor.default);
  ...
  const NavLink = ({ to, children, hasDropdown, onClick, icon }) => {
    ...
    return (
      <Link
        to={to}
        className={`${
          isActive ? "text-primary-6 font-semibold" : "text-gray-700"
    ...
    >
      ...
      >
        <Link
          ...
          className="block px-4 py-3 text-sm text-gray-700 hover:bg-gray-50 hover:text-primary-6 transition-colors duration-200"
          role="menuitem"
        >
  ...
  const DashboardDropdown = () => {
    ...
    const links = isDoctor
      ? [
          ...
          {
            to: PATH.doctor.patients,
            label: "My Patients",
            icon: <FaUserInjured className="mr-2" />,
          },
          {
            to: PATH.doctor.consultations,
      ...
      : [
          {
            to: PATH.dashboard.appointments,
            label: "My Appointments",
            icon: <FaCalendarAlt className="mr-2" />,
          },
          {
            to: PATH.dashboard.records,
            label: "Medical Records",
            icon: <FaFileMedical className="mr-2" />,
          },
          {
            to: PATH.dashboard.consultations,
            label: "Consultations",
            icon: <FaVideo className="mr-2" />,
          },
          {
  ...
  const MobileNavLink = ({ to, children, onClick, icon, delay }) => {
    ...
    return (
      ...
      >
        <div
          className={`w-10 h-10 rounded-xl flex items-center justify-center ${isActive ? "bg-primary-6 text-white" : "bg-gray-100 text-primary-6"}`}
        >
          {icon}
        </div>
        <span>{children}</span>
  ...
  const NotificationsPanel = () => {
    const notifications = useSelector((state) =>
      state.notifications.list.slice(0, 3),
    );
          ...
          {notifications.length > 0 ? (
            notifications.map((notification) => (
              <div
                ...
                className="p-4 flex gap-3 hover:bg-gray-100 transition-colors"
              >
          ...
          <div className="flex justify-between h-16">
            ...
            <div className="hidden md:flex items-center">
              <div className="hidden md:flex items-center space-x-1">
                <NavLink to={PATH.general.home} icon={<FaHome />}>
                  Home
                </NavLink>
                <NavLink to={PATH.general.about} icon={<FaInfoCircle />}>
                  About
                </NavLink>
                <NavLink to={PATH.general.doctors} icon={<FaUserMd />}>
                  Doctors
                </NavLink>
                <div className="relative">
                  <NavLink
                    to={PATH.general.services}
                    hasDropdown="services"
                    icon={<FaCubes />}
                  >
                    Services
            ...
            <div className="h-full flex flex-col">
              ...
              <div className="flex-1 overflow-y-auto p-6 space-y-3">
                ...
                >
                  ...
                  >
                    <div
                      className={`w-10 h-10 rounded-xl flex items-center justify-center ${isMobileServicesOpen ? "bg-primary-6 text-white" : "bg-gray-100 text-primary-6"}`}
                    >
